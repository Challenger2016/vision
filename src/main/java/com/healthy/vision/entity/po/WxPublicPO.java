...
public class WxPublicPO implements Serializable {
    ...
    /**
     * 只读.
    公众号类型：1-公众号，2-小程序. wx_public_type
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "公众号类型：1-公众号，2-小程序",name = "wxPublicType", required = false,example = "")
    private String wxPublicType;

    /**
     * 只读.
    小程序业务类型：10-个人中心小程序，20-微商城小程序，30-导购助手. mini_program_type
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "小程序业务类型：10-个人中心小程序，20-微商城小程序，30-导购助手",name = "miniProgramType", required = false,example = "")
     ...
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "公众号昵称",name = "nickName", required = false,example = "")
    ...
    /**
     * 只读.
    虚拟开放平台appid. open_appid
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "虚拟开放平台appid",name = "openAppid", required = false,example = "")
    private String openAppid;

    /**
     * 只读.
    关联公众号id，类型是小程序时才有值. associate_wx_public_id
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "关联公众号id，类型是小程序时才有值",name = "associateWxPublicId", required = false,example = "")
     ...
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "域名",name = "domain", required = false,example = "")
    private String domain;

    /**
     * 只读.
    二维码图片的url. qr_code_url
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    ...
    /**
     * 只读.
    公众号类型，0代表订阅号，1代表由历史老帐号升级后的订阅号，2代表服务号. service_type
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "公众号类型，0代表订阅号，1代表由历史老帐号升级后的订阅号，2代表服务号",name = "serviceType", required = false,example = "")
    private String serviceType;

    /**
     * 只读.
    公众号认证类型，-1代表未认证，0代表微信认证，1代表新浪微博认证，2代表腾讯微博认证，3代表已资质认证通过但还未通过名称认证，4代表已资质认证通过、还未通过名称认证，但通过了新浪微博认证，5代表已资质认证通过、还未通过名称认证，但通过了腾讯微博认证. verify_type
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "公众号认证类型，-1代表未认证，0代表微信认证，1代表新浪微博认证，2代表腾讯微博认证，3代表已资质认证通过但还未通过名称认证，4代表已资质认证通过、还未通过名称认证，但通过了新浪微博认证，5代表已资质认证通过、还未通过名称认证，但通过了腾讯微博认证",name = "verifyType", required = false,example = "")
    private String verifyType;

    /**
     * 只读.
    授权刷新码. authorizer_refresh_token
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "授权刷新码",name = "authorizerRefreshToken", required = false,example = "")
    private String authorizerRefreshToken;

    /**
     * 只读.
    授权码. authorizer_access_token
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "授权码",name = "authorizerAccessToken", required = false,example = "")
    private String authorizerAccessToken;

    /**
     * 只读.
    授权码过期时间. authorizer_access_token_time
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "授权码过期时间",name = "authorizerAccessTokenTime", required = false,example = "")
    private Long authorizerAccessTokenTime;

    /**
     * 只读.
    jssdk token. jssdk_access_token
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "jssdk token",name = "jssdkAccessToken", required = false,example = "")
    ...
    /**
     * 只读.
    jssdk token 过期时间. jssdk_access_token_time
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "jssdk token 过期时间",name = "jssdkAccessTokenTime", required = false,example = "")
    private Long jssdkAccessTokenTime;

    /**
     * 只读.
    第三方应用appid. platform_appid
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    ...
    /**
     * 只读.
    可根据这个字段判断是否为小程序类型授权. mini_program_info
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "可根据这个字段判断是否为小程序类型授权",name = "miniProgramInfo", required = false,example = "")
    private String miniProgramInfo;

    /**
     * 只读.
    公众号/小程序主体名称. principal_name
     *
     * @mbg.generated 2018-12-19 10:34:36
     */
    @io.swagger.annotations.ApiModelProperty(value = "公众号/小程序主体名称",name = "principalName", required = false,example = "")
     ...
     * @mbg.generated 2018-12-19 10:34:36
     */
    public void setWxPublicType(String wxPublicType) {
        this.wxPublicType = wxPublicType == null ? null : wxPublicType.trim();
    }
    ...
    public void setMiniProgramType(String miniProgramType) {
        this.miniProgramType = miniProgramType == null ? null : miniProgramType.trim();
    }
    ...
    public void setOpenAppid(String openAppid) {
        this.openAppid = openAppid == null ? null : openAppid.trim();
    }
     ...
     * @mbg.generated 2018-12-19 10:34:36
     */
    public void setAssociateWxPublicId(Long associateWxPublicId) {
        this.associateWxPublicId = associateWxPublicId;
    }
